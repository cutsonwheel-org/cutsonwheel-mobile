...
export class ProfilesPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.notifications = [
      { val: 'Send push notification', isChecked: true },
      { val: 'Send an email for invitations', isChecked: false },
      { val: 'Send an email events and updates', isChecked: false }
    ];

    this.experiences = [
      { val: 'Entry', isChecked: true },
      { val: 'Intermediate', isChecked: false },
      { val: 'Expert', isChecked: false }
    ];
  }
