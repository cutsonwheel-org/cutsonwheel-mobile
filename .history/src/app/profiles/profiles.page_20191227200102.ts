...
export class ProfilesPage implements OnInit {
  ...
  ngOnInit() {
    ...
    const u = this.authService.getUsersProfile();
    console.log(u);
    if (u != null) {
      // this.userProfile.displayName = u.displayName;
      this.userProfile.email = u.email;
      this.userProfile.photoURL = u.photoURL;
      this.userProfile.emailVerified = u.emailVerified;
      this.userProfile.id = u.uid;
    }
