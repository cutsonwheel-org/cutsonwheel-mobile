...
export class AccountPage implements OnInit, OnDestroy {
  ...
  async onTakePicture() {
    ...
    const imageData = result && result.base64String;
    this.image = this.domSanitizer.bypassSecurityTrustResourceUrl(imageData);
    // this.image = this.imagePicker.base64toBlob(
