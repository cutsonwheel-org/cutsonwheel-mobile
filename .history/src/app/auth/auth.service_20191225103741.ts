...
export class AuthService implements OnDestroy {
  ...
  login(enteredEmail: string, enteredPassword: string) {
    return this.angularFireAuth.auth.signInWithEmailAndPassword(enteredEmail, enteredPassword).then(res => {
        ...
        // userData.localId, userData.email, userData.idToken, userData.expiresIn
        // refreshToken
        // displayName: null
        // photoURL: null
        ...
        //   a: "1576636520803"
        //   b: "1577051975443"
        //   lastSignInTime: "Sun, 22 Dec 2019 21:59:35 GMT"
        //   creationTime: "Wed, 18 Dec 2019 02:35:20 GMT"
        this.setUserData.bind(res.user);
      }
    );
