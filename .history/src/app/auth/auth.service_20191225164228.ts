...
export class AuthService implements OnDestroy {
  ...
  signup(enteredEmail: string, enteredPassword: string) {
    return this.angularFireAuth.auth.createUserWithEmailAndPassword(enteredEmail, enteredPassword).then(res => {
      console.log(res);
//       refreshToken: "AEu4IL2DxsLNjDU0bqT5dbdFi_OhSnd88x7eMDo1_P_BS2DewNuR2RrtfOTPEvEeML9aDo5A9LEvT6cGke2ko9FSA3A93LFIh-PwP6DpJ5ZcWlq8QUCUmboedMseXtdFthG73amXJWIy8a9Eo6nE98NjUSNVQDjmVwyZaTEDSkBLa-tzrGj_iWFipoE6aUonS8guFwadr2rlQxPs53heHQsEGf-6ANGUuA"
// uid: "FTlnDZlolEQRJiUcdUKdv6HXFm82"
// displayName: null
// photoURL: null
// email: "cashit67@gmail.com"
// emailVerified: false
// phoneNumber: null
// isAnonymous: false
// tenantId: null
