...
export class WalletPage implements OnInit {
      ...
      if (user) {
        ...
        this.paymentsService.getByUserId(user.uid).subscribe((payments) => {
          ...
          payments.forEach(element => {
            ...
            this.lastVisible = element.lastVisible;
          });
  ...
  loadData(event) {
    this.paymentsService.getByUserIdByLastVisible(this.user.uid, this.lastVisible).subscribe((payments) => {
      if (this.lastVisible < payments.length) {
