...
export class WalletPage implements OnInit {
  ...
  appendItems(payments: any) {
    ...
    //     <ion-label>
    //       <h2>${element.transactions.itemList.shippingAddress.recipientName}</h2>
    //       <p>Created ${element.paymentCreatedTransformed}</p>
    //     </ion-label>
    //   `);
    ...
    //   const item = this.renderer.createText(`
    //     <ion-label>
    //       <h2>${payment.transactions.itemList.shippingAddress.recipientName}</h2>
    //       <p>Created ${payment.paymentCreatedTransformed}</p>
    //     </ion-label>
    //   `);
    //   this.renderer.appendChild(el, item);
    //   this.length++;
