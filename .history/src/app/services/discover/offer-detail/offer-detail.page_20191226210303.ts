  ...
  ngOnInit() {
    this.route.paramMap.subscribe(paramMap => {
      if (!paramMap.has('offerId')) {
        this.navCtrl.navigateBack('/t/places/discover');
        return;
      }
      this.isLoading = true;
  ...
  openBookingModal(mode: 'select' | 'random') {
    this.modalCtrl
      .create({
        ...
        componentProps: { selectedPlace: this.offer, selectedMode: mode }
      })
      .then(modalEl => {
        modalEl.present();
        ...
        if (resultData.role === 'confirm') {
          this.loadingCtrl
            ...
            .then(loadingEl => {
              ...
              const booking  = {
                placeId: this.offer.id,
                placeTitle: this.offer.title,
                placeImage: this.offer.imageUrl,
