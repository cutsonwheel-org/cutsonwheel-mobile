...
export class PaymentsService {
  ...
  private filterByClient(userId: string) {
  ...
  private filterByAssistant(userId: string) {
    return this.afs.collection<useClass>(
      collection,
      ref => ref
  ...
  getByClient(userId: string): Observable<useClass[]> {
    return this.fetchData(this.filterByClient(userId));
  }

  getByAssistant(userId: string): Observable<useClass[]> {
    return this.fetchData(this.filterByAssistant(userId));
  }
