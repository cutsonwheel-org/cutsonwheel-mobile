...
export class PaymentsService {
  ...
  private filterByUserId(userId: string, lastVisible?: any) {
  ...
  getByUserId(userId: string, lastVisible?: any): Observable<useClass[]> {
    return this.fetchData(this.filterByUserId(userId, lastVisible));
  }
