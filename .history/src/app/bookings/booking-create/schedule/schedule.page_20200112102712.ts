...
export class SchedulePage implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.schedule) {
      ...
      const mergeSchedule = new Misc().mergeDateTime(scheduleDate, timePicked);
      console.log(mergeSchedule);
      // schedue transformation
      // const year = scheduleDate.getFullYear();
      // const month = new Misc().pad(scheduleDate.getMonth() + 1);
      // const day = new Misc().pad(scheduleDate.getDate());
