...
export class ReviewPage implements OnInit {
  ...
  ngOnInit() {
    ...
    for (let i = 0; i < services.length; i++) {
      ...
      console.log(parseInt(element.duration.replace(/[^0-9]/g, ''), 10));
      totalTime += parseInt(element.duration.replace(/[^0-9]/g, ''), 10);
    }
    ...
    pickedSchedule.setMinutes(pickedSchedule.getMinutes() + totalTime);
    console.log(pickedSchedule);
    // this.endUntil
  }
