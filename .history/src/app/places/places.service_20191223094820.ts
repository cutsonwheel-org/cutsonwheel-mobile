...
export class PlacesService {
  ...
  getOnePlace(id: string): Observable<Places> {
  ...
  insertPlace(place: Places): Promise<DocumentReference> {
    return this.placesCol.add(place);
  }

  // updateBooking(place: Places): Promise<void> {
  //   return this.placesCol.doc(place.id).update({
  //     name: place.name,
  //     notes: place.notes
  //   });
  // }
